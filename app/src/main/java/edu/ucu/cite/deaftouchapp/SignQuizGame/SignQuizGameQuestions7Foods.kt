...
class SignQuizGameQuestions7Foods : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList  = Constants7.getQuestions()
    ...
    private fun defaultOptionsView() {
        ...
        for (option in options) {
            ...
            option.background = ContextCompat.getDrawable(
                    this@SignQuizGameQuestions7Foods,
...
//                    Toast.makeText(this@SignQuizGameQuestions, "Please Choose An Answer", Toast.LENGTH_SHORT).show()
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            progressDialog = ProgressDialog(this@SignQuizGameQuestions7Foods)

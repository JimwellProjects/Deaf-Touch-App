...
class SignQuizGameQuestions9Months : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList  = Constants9.getQuestions()
    ...
    private fun defaultOptionsView() {
        ...
        for (option in options) {
            ...
            option.background = ContextCompat.getDrawable(
                    this@SignQuizGameQuestions9Months,
...
//                    Toast.makeText(this@SignQuizGameQuestions, "Please Choose An Answer", Toast.LENGTH_SHORT).show()
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            progressDialog = ProgressDialog(this@SignQuizGameQuestions9Months)

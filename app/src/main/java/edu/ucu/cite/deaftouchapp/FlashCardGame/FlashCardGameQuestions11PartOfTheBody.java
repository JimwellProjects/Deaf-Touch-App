...
public class FlashCardGameQuestions11PartOfTheBody extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.PartsOfTheBody_question_1,R.drawable.bodyparts_mouth,R.drawable.bodyparts_neck,R.drawable.bodyparts_mouth),
                    new answerclass(R.string.PartsOfTheBody_question_2,R.drawable.bodyparts_hair,R.drawable.bodyparts_heart,R.drawable.bodyparts_heart),
                    new answerclass(R.string.PartsOfTheBody_question_3,R.drawable.bodyparts_back,R.drawable.bodyparts_bald,R.drawable.bodyparts_back),
                    new answerclass(R.string.PartsOfTheBody_question_4,R.drawable.bodyparts_ear,R.drawable.bodyparts_face,R.drawable.bodyparts_ear),
                    new answerclass(R.string.PartsOfTheBody_question_5,R.drawable.bodyparts_hands,R.drawable.bodyparts_hair,R.drawable.bodyparts_hair),
                    new answerclass(R.string.PartsOfTheBody_question_6,R.drawable.bodyparts_bald,R.drawable.bodyparts_ear,R.drawable.bodyparts_bald),
                    new answerclass(R.string.PartsOfTheBody_question_7,R.drawable.bodyparts_stomach,R.drawable.bodyparts_nose,R.drawable.bodyparts_stomach),
                    new answerclass(R.string.PartsOfTheBody_question_8,R.drawable.bodyparts_nose,R.drawable.bodyparts_stomach,R.drawable.bodyparts_nose),
                    new answerclass(R.string.PartsOfTheBody_question_9,R.drawable.bodyparts_hands,R.drawable.bodyparts_neck,R.drawable.bodyparts_neck),
                    new answerclass(R.string.PartsOfTheBody_question_10,R.drawable.bodyparts_heart,R.drawable.bodyparts_hands,R.drawable.bodyparts_hands),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions11PartOfTheBody.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions11PartOfTheBody.this,FlashCardGameResult.class);

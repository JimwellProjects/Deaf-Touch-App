...
public class FlashCardGameQuestions5Colors extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Colors_question_1,R.drawable.colors_gold,R.drawable.colors_green,R.drawable.colors_gold),
                    new answerclass(R.string.Colors_question_2,R.drawable.colors_orange,R.drawable.colors_purple,R.drawable.colors_purple),
                    new answerclass(R.string.Colors_question_3,R.drawable.colors_red,R.drawable.colors_yellow,R.drawable.colors_red),
                    new answerclass(R.string.Colors_question_4,R.drawable.colors_brown,R.drawable.colors_tan,R.drawable.colors_tan),
                    new answerclass(R.string.Colors_question_5,R.drawable.colors_black,R.drawable.colors_brown,R.drawable.colors_black),
                    new answerclass(R.string.Colors_question_6,R.drawable.colors_tan,R.drawable.colors_orange,R.drawable.colors_orange),
                    new answerclass(R.string.Colors_question_7,R.drawable.colors_blue,R.drawable.colors_gold,R.drawable.colors_blue),
                    new answerclass(R.string.Colors_question_8,R.drawable.colors_green,R.drawable.colors_yellow,R.drawable.colors_yellow),
                    new answerclass(R.string.Colors_question_9,R.drawable.colors_orange,R.drawable.colors_green,R.drawable.colors_green),
                    new answerclass(R.string.Colors_question_10,R.drawable.colors_brown,R.drawable.colors_purple,R.drawable.colors_brown),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions5Colors.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions5Colors.this,FlashCardGameResult.class);

...
public class FlashCardGameQuestions3Greetings extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Greetings_question_1,R.drawable.greetings_goodmorning,R.drawable.greetings_hello,R.drawable.greetings_goodmorning),
                    new answerclass(R.string.Greetings_question_2,R.drawable.greetings_thankyou,R.drawable.greetings_goodbye,R.drawable.greetings_goodbye),
                    new answerclass(R.string.Greetings_question_3,R.drawable.greetings_welcome,R.drawable.greetings_goodday,R.drawable.greetings_welcome),
                    new answerclass(R.string.Greetings_question_4,R.drawable.greetings_hello,R.drawable.greetings_goodtoseeyou,R.drawable.greetings_goodtoseeyou),
                    new answerclass(R.string.Greetings_question_5,R.drawable.greetings_nicetomeetyou,R.drawable.greetings_thankyou,R.drawable.greetings_nicetomeetyou),
                    new answerclass(R.string.Greetings_question_6,R.drawable.greetings_goodevening,R.drawable.greetings_imfine,R.drawable.greetings_goodevening),
                    new answerclass(R.string.Greetings_question_7,R.drawable.greetings_goodbye,R.drawable.greetings_hello,R.drawable.greetings_hello),
                    new answerclass(R.string.Greetings_question_8,R.drawable.greetings_goodafternoon,R.drawable.greetings_goodevening,R.drawable.greetings_goodafternoon),
                    new answerclass(R.string.Greetings_question_9,R.drawable.greetings_thankyou,R.drawable.greetings_whatsgoingon,R.drawable.greetings_whatsgoingon),
                    new answerclass(R.string.Greetings_question_10,R.drawable.greetings_longtimenosee,R.drawable.greetings_goodday,R.drawable.greetings_longtimenosee),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions3Greetings.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions3Greetings.this,FlashCardGameResult.class);

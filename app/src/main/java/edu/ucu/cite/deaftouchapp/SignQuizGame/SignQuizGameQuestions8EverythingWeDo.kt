...
class SignQuizGameQuestions8EverythingWeDo : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList  = Constants8.getQuestions()
    ...
    private fun defaultOptionsView() {
        ...
        for (option in options) {
            ...
            option.background = ContextCompat.getDrawable(
                    this@SignQuizGameQuestions8EverythingWeDo,
...
//                    Toast.makeText(this@SignQuizGameQuestions, "Please Choose An Answer", Toast.LENGTH_SHORT).show()
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            progressDialog = ProgressDialog(this@SignQuizGameQuestions8EverythingWeDo)

...
public class VideosPage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        getLifecycle().addObserver(youTubePlayerView);
        ...
        adapter = new Adapter(VideosPage.this, list);
    ...
    public void BackButton(View view) {
        Intent i = new Intent(VideosPage.this,MainActivity.class);
        startActivity(i);
        overridePendingTransition(R.anim.fadein,R.anim.fadeout);
    }

    public void BasicASl(View view) {
        Intent i = new Intent(VideosPage.this,VideosPageContent.class);
        startActivity(i);
        overridePendingTransition(R.anim.fadein,R.anim.fadeout);
    }

    public void VideosPageWatch(View view) {

        Intent i = new Intent(VideosPage.this,VideosPageWatch.class);
        startActivity(i);
        overridePendingTransition(R.anim.fadein,R.anim.fadeout);
    }

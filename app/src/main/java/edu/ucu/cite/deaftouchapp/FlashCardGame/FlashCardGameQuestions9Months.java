...
public class FlashCardGameQuestions9Months extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Months_question_1,R.drawable.months_february,R.drawable.months_april,R.drawable.months_february),
                    new answerclass(R.string.Months_question_2,R.drawable.months_july,R.drawable.months_may,R.drawable.months_may),
                    new answerclass(R.string.Months_question_3,R.drawable.months_october,R.drawable.months_december,R.drawable.months_october),
                    new answerclass(R.string.Months_question_4,R.drawable.months_june,R.drawable.months_august,R.drawable.months_august),
                    new answerclass(R.string.Months_question_5,R.drawable.months_march,R.drawable.months_january,R.drawable.months_march),
                    new answerclass(R.string.Months_question_6,R.drawable.months_august,R.drawable.months_june,R.drawable.months_june),
                    new answerclass(R.string.Months_question_7,R.drawable.months_april,R.drawable.months_may,R.drawable.months_april),
                    new answerclass(R.string.Months_question_8,R.drawable.months_november,R.drawable.months_july,R.drawable.months_july),
                    new answerclass(R.string.Months_question_9,R.drawable.months_december,R.drawable.months_january,R.drawable.months_december),
                    new answerclass(R.string.Months_question_10,R.drawable.months_april,R.drawable.months_january,R.drawable.months_january),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions9Months.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions9Months.this,FlashCardGameResult.class);

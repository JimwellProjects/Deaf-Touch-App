...
class SignQuizGameQuestions5Colors : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList  = Constants5.getQuestions()
    ...
    private fun defaultOptionsView() {
        ...
        for (option in options) {
            ...
            option.background = ContextCompat.getDrawable(
                    this@SignQuizGameQuestions5Colors,
...
//                    Toast.makeText(this@SignQuizGameQuestions, "Please Choose An Answer", Toast.LENGTH_SHORT).show()
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            progressDialog = ProgressDialog(this@SignQuizGameQuestions5Colors)

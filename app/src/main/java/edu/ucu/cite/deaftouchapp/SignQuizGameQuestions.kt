...
class SignQuizGameQuestions : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sign_quiz_game_questions)
...
//                    Toast.makeText(this@SignQuizGameQuestions, "Please Choose An Answer", Toast.LENGTH_SHORT).show()
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            progressDialog = ProgressDialog(this@SignQuizGameQuestions)
                            progressDialog!!.setMessage("Please wait....")
                            val stringRequest: StringRequest = object : StringRequest(
                                    Method.POST,
                                    "https://deagtouch.000webhostapp.com/DeafTouch/InsertScore.php",
        ...
        AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes") { dialog, which ->
                    startActivity(
                            Intent(
                                    applicationContext,
                                    SignQuizGameSelectCategories::class.java
                            )
                    )
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout)
                    finish()

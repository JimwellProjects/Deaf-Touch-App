...
class SignQuizGameQuestions12FamilyMember : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionList  = Constants12.getQuestions()
    ...
    private fun defaultOptionsView() {
        ...
        for (option in options) {
            ...
            option.background = ContextCompat.getDrawable(
                    this@SignQuizGameQuestions12FamilyMember,
...
//                    Toast.makeText(this@SignQuizGameQuestions, "Please Choose An Answer", Toast.LENGTH_SHORT).show()
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            progressDialog = ProgressDialog(this@SignQuizGameQuestions12FamilyMember)

...
public class FlashCardGameQuestions6Animals extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Animals_question_1,R.drawable.animals_bear,R.drawable.animals_cat,R.drawable.animals_bear),
                    new answerclass(R.string.Animals_question_2,R.drawable.animals_dog,R.drawable.animals_bird,R.drawable.animals_bird),
                    new answerclass(R.string.Animals_question_3,R.drawable.animals_owl,R.drawable.animals_rat,R.drawable.animals_owl),
                    new answerclass(R.string.Animals_question_4,R.drawable.animals_snake,R.drawable.animals_tiger,R.drawable.animals_tiger),
                    new answerclass(R.string.Animals_question_5,R.drawable.animals_zibra,R.drawable.animals_pig,R.drawable.animals_zibra),
                    new answerclass(R.string.Animals_question_6,R.drawable.animals_giraffe,R.drawable.animals_fish,R.drawable.animals_fish),
                    new answerclass(R.string.Animals_question_7,R.drawable.animals_elephant,R.drawable.animals_dog,R.drawable.animals_elephant),
                    new answerclass(R.string.Animals_question_8,R.drawable.animals_dog,R.drawable.animals_cat,R.drawable.animals_cat),
                    new answerclass(R.string.Animals_question_9,R.drawable.animals_mouse,R.drawable.animals_dog,R.drawable.animals_mouse),
                    new answerclass(R.string.Animals_question_10,R.drawable.animals_lion,R.drawable.animals_pig,R.drawable.animals_pig),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions6Animals.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions6Animals.this,FlashCardGameResult.class);

...
public class FlashCardGameQuestions7Foods extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Foods_question_1,R.drawable.foods_meat,R.drawable.foods_hotdog,R.drawable.foods_meat),
                    new answerclass(R.string.Foods_question_2,R.drawable.foods_egg,R.drawable.foods_coffee,R.drawable.foods_coffee),
                    new answerclass(R.string.Foods_question_3,R.drawable.foods_sandwich,R.drawable.foods_milk,R.drawable.foods_sandwich),
                    new answerclass(R.string.Foods_question_4,R.drawable.foods_cake,R.drawable.foods_bread,R.drawable.foods_bread),
                    new answerclass(R.string.Foods_question_5,R.drawable.foods_cereal,R.drawable.foods_chicken,R.drawable.foods_cereal),
                    new answerclass(R.string.Foods_question_6,R.drawable.foods_milk,R.drawable.foods_vegetable,R.drawable.foods_vegetable),
                    new answerclass(R.string.Foods_question_7,R.drawable.foods_pizza,R.drawable.foods_hotdog,R.drawable.foods_pizza),
                    new answerclass(R.string.Foods_question_8,R.drawable.foods_candy,R.drawable.foods_hotdog,R.drawable.foods_hotdog),
                    new answerclass(R.string.Foods_question_9,R.drawable.foods_salad,R.drawable.foods_soda_pop,R.drawable.foods_salad),
                    new answerclass(R.string.Foods_question_10,R.drawable.foods_cereal,R.drawable.foods_cake,R.drawable.foods_cake),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions7Foods.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions7Foods.this,FlashCardGameResult.class);

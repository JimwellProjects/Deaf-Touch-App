...
public class FlashCardGameQuestions10Questions extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Questions_question_1,R.drawable.questions_whereyoufrom,R.drawable.questions_who,R.drawable.questions_whereyoufrom),
                    new answerclass(R.string.Questions_question_2,R.drawable.questions_who,R.drawable.questions_why,R.drawable.questions_why),
                    new answerclass(R.string.Questions_question_3,R.drawable.questions_which,R.drawable.questions_where,R.drawable.questions_which),
                    new answerclass(R.string.Questions_question_4,R.drawable.questions_whatkind,R.drawable.questions_whoisthat,R.drawable.questions_whoisthat),
                    new answerclass(R.string.Questions_question_5,R.drawable.questions_whatkind,R.drawable.questions_howareyou,R.drawable.questions_whatkind),
                    new answerclass(R.string.Questions_question_6,R.drawable.questions_what,R.drawable.questions_whatdo,R.drawable.questions_whatdo),
                    new answerclass(R.string.Questions_question_7,R.drawable.questions_what,R.drawable.questions_why,R.drawable.questions_what),
                    new answerclass(R.string.Questions_question_8,R.drawable.questions_how,R.drawable.questions_youok,R.drawable.questions_youok),
                    new answerclass(R.string.Questions_question_9,R.drawable.questions_how,R.drawable.questions_what,R.drawable.questions_how),
                    new answerclass(R.string.Questions_question_10,R.drawable.questions_howareyou,R.drawable.questions_howmuch,R.drawable.questions_howmuch),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions10Questions.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions10Questions.this,FlashCardGameResult.class);

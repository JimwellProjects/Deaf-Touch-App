...
public class FlashCardGameQuestions13Shapes extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Shapes_question_1,R.drawable.shapes_square,R.drawable.shapes_circle,R.drawable.shapes_circle),
                    new answerclass(R.string.Shapes_question_2,R.drawable.shapes_star,R.drawable.shapes_triangle,R.drawable.shapes_star),
                    new answerclass(R.string.Shapes_question_3,R.drawable.shapes_diamond,R.drawable.shapes_oval,R.drawable.shapes_diamond),
                    new answerclass(R.string.Shapes_question_4,R.drawable.shapes_square,R.drawable.shapes_triangle,R.drawable.shapes_triangle),
                    new answerclass(R.string.Shapes_question_5,R.drawable.shapes_oval,R.drawable.shapes_cone,R.drawable.shapes_oval),
                    new answerclass(R.string.Shapes_question_6,R.drawable.shapes_triangle,R.drawable.shapes_rectangle,R.drawable.shapes_rectangle),
                    new answerclass(R.string.Shapes_question_7,R.drawable.shapes_cone,R.drawable.shapes_star,R.drawable.shapes_cone),
                    new answerclass(R.string.Shapes_question_8,R.drawable.shapes_circle,R.drawable.shapes_square,R.drawable.shapes_square),
                    new answerclass(R.string.Shapes_question_9,R.drawable.shapes_heart,R.drawable.shapes_diamond,R.drawable.shapes_heart),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions13Shapes.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions13Shapes.this,FlashCardGameResult.class);

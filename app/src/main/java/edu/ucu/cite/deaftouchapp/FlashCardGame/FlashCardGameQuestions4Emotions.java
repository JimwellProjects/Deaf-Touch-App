...
public class FlashCardGameQuestions4Emotions extends AppCompatActivity {
...
//    ProgressBar progressBar;
    ...
    private final answerclass[] questionBank= new answerclass[]
            {
                    new answerclass(R.string.Emotions_question_1,R.drawable.emotiosn_contented,R.drawable.emotiosn_cheeky,R.drawable.emotiosn_contented),
                    new answerclass(R.string.Emotions_question_2,R.drawable.emotiosn_calm,R.drawable.emotiosn_relax,R.drawable.emotiosn_relax),
                    new answerclass(R.string.Emotions_question_3,R.drawable.emotiosn_sad,R.drawable.emotiosn_sleepy,R.drawable.emotiosn_sad),
                    new answerclass(R.string.Emotions_question_4,R.drawable.emotiosn_surprised,R.drawable.emotiosn_tense,R.drawable.emotiosn_tense),
                    new answerclass(R.string.Emotions_question_5,R.drawable.emotiosn_happy,R.drawable.emotiosn_sad,R.drawable.emotiosn_happy),
                    new answerclass(R.string.Emotions_question_6,R.drawable.emotiosn_angry,R.drawable.emotiosn_sorry,R.drawable.emotiosn_sorry),
                    new answerclass(R.string.Emotions_question_7,R.drawable.emotiosn_depressed,R.drawable.emotiosn_excited,R.drawable.emotiosn_depressed),
                    new answerclass(R.string.Emotions_question_8,R.drawable.emotiosn_cheeky,R.drawable.emotiosn_angry,R.drawable.emotiosn_angry),
                    new answerclass(R.string.Emotions_question_9,R.drawable.emotiosn_nervous,R.drawable.emotiosn_sad,R.drawable.emotiosn_nervous),
                    new answerclass(R.string.Emotions_question_10,R.drawable.emotiosn_sorry,R.drawable.emotiosn_upset,R.drawable.emotiosn_upset),
...
//        progressBar=findViewById(R.id.progress_bar);
    ...
    private void updateQuestion() {
        ...
        if(currentIndex==0)
        {
            ...
            progressDialog = new ProgressDialog(FlashCardGameQuestions4Emotions.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Intent intent = new Intent(FlashCardGameQuestions4Emotions.this,FlashCardGameResult.class);
